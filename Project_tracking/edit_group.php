...
// $da = mysqli_query($con,"select * from group");
            ...
            <div class="tile-body">
              <form method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="department" id="exampleSelect1">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="details" placeholder="Enter group details"></textarea>
                </div>
                <div class="form-group">

...
if(isset($_POST['sub'])){
    ...
    mysqli_query($con,"insert into `schedules`(group_id,note,date)values('$group_id','$note','$date')");
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                    ...
                    <select class="form-control" name="group" id="exampleSelect1" required>
                      <option aria-readonly="">Select Group</option>
                        <?php
                         while($dat0 = mysqli_fetch_assoc($dat)){
                        ?>
                      <option value="<?php echo $dat0['group_id'] ?>"><?php echo $dat0['name'] ?></option>
                      <?php
                        }
                       ?>
                    </select>

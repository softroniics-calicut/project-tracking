            ...
            <div class="tile-body">
              <form method="post">
                <div class="form-group">
                  ...
                  <input class="form-control" required type="text" name="title" placeholder="Enter department name">
                </div>
                <div class="form-group">
                  <label class="control-label">Content</label>
                  <input class="form-control" required type="text" name="content" placeholder="Enter department name">
                </div>

...
class _ViewState extends State<View> {
  ...
  String? img ;
  //  String fileurl = "https://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf";
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    //     child: PhotoView(
                    //       imageProvider: AssetImage('assets/images/${snap.data![index]['file']}'),
                    //
                    //     ),
                    //
                    // ),
                    ...
                    trailing: InkWell(
                        onTap: () async {
                          String fileurl = "http://192.168.29.60/project_tracking/images/${snap.data![index]['file']}";
